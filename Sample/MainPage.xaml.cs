...
namespace Sample
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            count++;
            await DisplayAlert("Alert!", $"You have clicked {count} times now", "Acceptable.");
        }
         ...
         */
        async private void FCM_textonly()
        {
            await DisplayAlert("Push FCM token", "placeholder function", "Acceptable.");
        }
